...
$parser->footnoteBackLinkAttributes = function($Number, $Attributes, $Element, $Name, $Count) {
    return array(
        'data-name' => $Name,
        'data-count' => $Count
    );
...
$parser->footnoteBackReferenceAttributes = function($Number, $Attributes, $Element, $Name, $Count) {
    return array(
        'data-name' => $Name,
        'data-count' => $Count, // should be null
    );
};
